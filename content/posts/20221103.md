...
tags: ["tech", "日本語", "telegram", "python", "bot"]
author: "Me"
showToc: true
TocOpen: false
draft: false
...
### ニュースの取得
ニュースの取得方法は先日開発したWebアプリと同じく[NewsAPI](https://newsapi.org/)利用して取得しています。なぜNewsAPIを採用したかについては[半年前の記事](https://zenn.dev/jcc/articles/e672181fd7b174)で詳細を説明したので、割愛します。
